...
import zut.edu.cn.notepad.activity.KyActivity
import zut.edu.cn.notepad.activity.MainActivity
import zut.edu.cn.notepad.api.CacheUtil
import zut.edu.cn.notepad.bean.DBService
import zut.edu.cn.notepad.cursom.NoRepeatClickListener
import zut.edu.cn.notepad.cursom.TitleBar
import zut.edu.cn.notepad.cursom.Utils
import java.io.IOException
import java.util.*

class AboutActivity : AppCompatActivity() {
    private var txtCacheSize: TextView? = null
    var myDb: DBService? = null
    ...
    private fun initView() {
        ...
        try {
            txtCacheSize!!.text = CacheUtil.getTotalCacheSize(this)
    ...
    private fun showDialog() {
        try {
            ...
            db.execSQL("delete from " + DBService.TABLE)
    ...
    val handler: Handler = object : Handler() {
        ...
        override fun handleMessage(msg: Message) {
            if (msg.what == 0) {
                ...
                txtCacheSize!!.text = CacheUtil.getTotalCacheSize(this@AboutActivity)
            }
